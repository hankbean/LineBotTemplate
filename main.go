			...
			switch message := event.Message.(type) {
				case *linebot.TextMessage:
					...
					if message.Text=="早餐" || message.Text=="午餐"  || message.Text=="晚餐"|| message.Text=="吃什麼"{
						...
						mesText = "表象 ASC:" + asc[ascNum] + "，\n月亮" + strconv.Itoa(MoonNum+1) + "，太陽" + strconv.Itoa(SunNum+1) + "，水星" + strconv.Itoa(qNum+1) + "，金星" + strconv.Itoa(wNum+1) + "，火星" + strconv.Itoa(eNum+1) + "，木星" + strconv.Itoa(rNum+1) + "，土星" + strconv.Itoa(tNum+1) + "，天王星" + strconv.Itoa(yNum+1) + "，海王星" + strconv.Itoa(uNum+1) + "，冥王星" + strconv.Itoa(iNum+1) + "宮";
