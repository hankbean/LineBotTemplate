			...
			switch message := event.Message.(type) {
				case *linebot.TextMessage:
					...
					if message.Text=="早餐" || message.Text=="午餐"  || message.Text=="晚餐"|| message.Text=="吃什麼"{
						...
						mesText = "表象 ASC:" + asc[ascNum] + "\n月亮" + strconv.Itoa(MoonNum+1) + "\n太陽" + strconv.Itoa(SunNum+1) + "\n水星" + strconv.Itoa(qNum+1) + "\n金星" + strconv.Itoa(wNum+1) + "宮\n火星" + strconv.Itoa(eNum+1) + "宮\n木星" + strconv.Itoa(rNum+1) + "宮\n土星" + strconv.Itoa(tNum+1) + "宮\n天王星" + strconv.Itoa(yNum+1) + "宮\n海王星" + strconv.Itoa(uNum+1) + "宮\n冥王星" + strconv.Itoa(iNum+1) + "宮宮\n";
						...
						mesText = mesText + "\n事實 ASC:" + asc[ascNum] + "\n月亮" + strconv.Itoa(MoonNum+1) + "宮\n太陽" + strconv.Itoa(SunNum+1) + "宮\n水星" + strconv.Itoa(qNum+1) + "宮\n金星" + strconv.Itoa(wNum+1) + "宮\n火星" + strconv.Itoa(eNum+1) + "宮\n木星" + strconv.Itoa(rNum+1) + "宮\n土星" + strconv.Itoa(tNum+1) + "宮\n天王星" + strconv.Itoa(yNum+1) + "宮\n海王星" + strconv.Itoa(uNum+1) + "宮\n冥王星" + strconv.Itoa(iNum+1) + "宮";
						bot.ReplyMessage(event.ReplyToken, linebot.NewTextMessage(mesText)).Do()
